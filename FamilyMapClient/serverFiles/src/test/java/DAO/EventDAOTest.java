...
public class EventDAOTest {
    ...
    @Test
    public void addEventsPass() throws Exception
    {
        ArrayList<Event> output = null;
        Event testModel2 = null;
        try {
            Connection conn = db.openConnection();
            EventDAO eDao = new EventDAO(conn);
            eDao.insert(bestEvent);
            testModel2 = new Event("Biking_123B", "Gale", "Gale123B",
                    10.3f, 10.3f, "Japan", "Ushike",
                    "Biking_Around", 2015);
            eDao.insert(testModel2);
            output = eDao.getEvents(bestEvent.getAssociatedUsername());
        ...
        assertEquals(output.get(0), bestEvent);
    ...
    @Test
    public void addEventsFail()throws Exception{
        ArrayList<Event> output = null;
        try{
            Connection conn = db.openConnection();
            EventDAO eDao = new EventDAO(conn);
